const Logo = () => {
  return (
    <div className="logo bg-white rounded-full aspect-square object-cover flex items-center justify-center w-28 h-28 shadow-xl transition-all hover:shadow-2xl text-black hover:bg-black hover:text-white">
